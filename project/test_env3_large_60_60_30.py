...
1. Size: 
   Environments: 60 * 60 * 30
   Matched .binvox model: 20 * 20 * 15
2. Movement: 
...
class working_space_test3(gym.Env):
    '''  
    Funcitons:
        -------------------------
    ...
    def __init__(self,
                 material_name = 'test_material3_20_20_15.binvox',
                 product_name = 'test_product3_20_20_15.binvox',
                 space_x = 60, 
                 space_y = 60, 
                 space_z = 30, 
                 s_neutral = 0,
